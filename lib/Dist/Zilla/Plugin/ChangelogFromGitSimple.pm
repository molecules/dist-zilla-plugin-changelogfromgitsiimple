package Dist::Zilla::Plugin::ChangelogFromGitSimple;
# ABSTRACT: Write a simple Changes file from a project's git log.
...
For the original module ChangelogFromGit
...
Most of this software is copyright (c) 2010-2018 by Rocco Caputo.
Changes making it ChangelogFromGitSimple (and changes thereafter) are 
copyright (c) 2018 by Christopher Bottoms.
